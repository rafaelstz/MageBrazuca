...
<?php if ($allPosts) : ?>
<h1>Busca por "<?php echo $searchQuery; ?>"</h1>
...
<div id="all-posts-posts-box">
    ...
    <a id="posts-previous-page" href="/search/<?php echo $searchQuery; ?>/<?php echo $previousPage; ?>">Anterior</a>
    <?php endif; ?>
    <?php if ($currentPage < $maxPage) : ?>
    <a id="posts-next-page" href="/search/<?php echo $searchQuery; ?>/<?php echo $nextPage; ?>">Próxima</a>
    <?php endif; ?>
</div>
...
<?php else : ?>
<p>Nenhum resultado de busca por "<?php echo $searchQuery; ?>".</p>
<?php endif; ?>