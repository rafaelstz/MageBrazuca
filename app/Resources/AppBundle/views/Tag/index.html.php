...
<?php if ($allPosts) : ?>
<h1>Posts com a tag "<?php echo $tag; ?>"</h1>
...
<div id="all-posts-posts-box">
    ...
    <a id="posts-previous-page" href="/tag/<?php echo $tag; ?>/<?php echo $previousPage; ?>">Anterior</a>
    <?php endif; ?>
    <?php if ($currentPage < $maxPage) : ?>
    <a id="posts-next-page" href="/tag/<?php echo $tag; ?>/<?php echo $nextPage; ?>">Próxima</a>
    <?php endif; ?>
</div>
...
<?php else : ?>
<p>Nenhum resultado para a tag "<?php echo $tag; ?>".</p>
<?php endif; ?>